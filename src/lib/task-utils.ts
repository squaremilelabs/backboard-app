...
export const TASK_TARGET_DISPLAY_MAP: Record<TaskTarget, { label: string; className: string }> = {
  ...
  THIS_MONTH: { label: "This month", className: "bg-blue-200 text-blue-700" },
  NEXT_MONTH: { label: "Next month", className: "bg-purple-100 text-purple-600" },
  SOMEDAY: { label: "Someday", className: "bg-neutral-100 text-purple-600" },
