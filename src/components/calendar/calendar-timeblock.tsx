...
import TimeblockTimeslots from "./timeblock-timeslots"
import { getTimeslotStatus, Timeblock } from "@/lib/utils-timeslot"
  ...
  return (
    <div
      ...
      className={twMerge(
        ...
        "overflow-auto",
        status === "past" ? "bg-neutral-100" : "bg-canvas",
    ...
    >
      <div
        className={twMerge(
          ...
          status === "past" ? "bg-neutral-100/50" : "bg-canvas/50"
        )}
      >
      ...
      <div className="h-120 min-h-120">
        <TimeblockTimeslots dateString={dateString} timeblock={timeblock} />
      </div>
    </div>
  )
}
